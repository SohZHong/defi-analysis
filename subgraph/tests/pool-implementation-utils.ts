...
export function createReserveDataUpdated1Event(
  reserve: Address,
  liquidityRate: BigInt,
  stableBorrowRate: BigInt,
  variableBorrowRate: BigInt,
  ...
  let reserveDataUpdated1Event = changetype<ReserveDataUpdated1>(newMockEvent())

  reserveDataUpdated1Event.parameters = new Array()

  reserveDataUpdated1Event.parameters.push(
    new ethereum.EventParam("reserve", ethereum.Value.fromAddress(reserve))
  )
  reserveDataUpdated1Event.parameters.push(
    new ethereum.EventParam(
  ...
  return reserveDataUpdated1Event
}
